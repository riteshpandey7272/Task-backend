...
const ShowChefOrderComplete = ({ orderId, updateOrderStatus }) => {
  ...
  const handleApprove = async () => {
    ...
    setError(null); 
    try {
      await axios.put(`/orders/${orderId}/orderStatusComplete`);
  ...
  return (
    <div className="ShowChefOrderComplete-head">
      <h2>Order Details</h2>
...
export default ShowChefOrderComplete;
